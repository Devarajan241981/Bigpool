      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <label htmlFor="terms" className="text-xs text-gray-600">
                I agree to Bigpool's{" "}
                <Link href="#" className="text-[#0d9488] hover:underline">Terms of Service</Link>{" "}
                and{" "}
                <Link href="#" className="text-[#0d9488] hover:underline">Privacy Policy</Link>
              </label>
            </div>
          ...
          <div className="mt-4 text-center text-sm text-gray-500">
            ...
            <Link href="/customer/login" className="text-[#0d9488] hover:underline font-medium">
              Sign in
            </Link>
          </div>
